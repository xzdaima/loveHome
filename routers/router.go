...
func init() {
	...
	beego.Router("api/v1.0/houses", &controllers.HousesController{}, "post:UploadHouseInfo")
	beego.Router("api/v1.0/houses/:id:int/images", &controllers.HousesController{}, "post:UploadHousePic")

	beego.Router("api/v1.0/user/houses/:id:int", &controllers.HousesController{}, "get:GetHouseInfo")
